...
<html lang="en">
                    ...
                    >
                      ...
                      <div >
                        ...
                        >
                            ...
                            <option value="cadeira" class="text-body">sssssss</option>
                        </select>
                        <span
                            class="absolute right-4 top-1/2 z-30-translate-y-1/2"
                        >
  ...
  <script>
    ...
    yearSelect.addEventListener('change', () => {
        fillSubjectSelect(yearSelect, subjectSelect);
    })

    function fillSubjectSelect(yearSelect, subjectSelect) {
        fetch(`/search_subject_by_year/${yearSelect.value}`)
    ...
    subjectSelect.addEventListener('change', () => {
        fetch(`/search_files/${subjectSelect.value}`)
        .then(response => response.json())
        .then(files => {
