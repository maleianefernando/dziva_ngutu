...
=======
    <title>Cursos | Dziva Ngutu</title>
>>>>>>> test
    @vite(['resources/css/app.css', 'resources/js/app.js'])
  </head>

  <body
    x-data="{ page: 'listarCurso', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
...
=======
                            @foreach ($courses as $c)
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    {{ \App\Models\Faculty::where('id', $c->faculty_id)->first()->name }}
                                    </td>
                                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                    {{ $c->duration === null ? 'Não foi fornecido' : $c->duration === null }}
                                    </td>
                                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
