...
>
  <!-- SIDEBAR HEADER -->
  <div class="flex items-center justify-between gap-2 px-4 py-5.5 lg:py-6.5">
    <a href="index.html">
        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'Forms') || (page === 'formElements' || page === 'formLayout'  || page === 'registarDocente' || page === 'registarEstudante' || page === 'registarFaculdade' || page === 'registarCurso' || page === 'registarCadeira') }"
            >
              <svg
                class="fill-current"
                width="18"
              ...
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    ...
                    href="{{route('registar.estudante')}}"
                    :class="page === 'registarEstudante' && '!text-white'"
                    >Estudantes</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('registar.docente')}}"
                    :class="page === 'registarDocente' && '!text-white'"
                    >Docentes</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('registar.faculdade')}}"
                    :class="page === 'registarFaculdade' && '!text-white'"
                    >Faculdade</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('registar.curso')}}"
                    :class="page === 'registarCurso' && '!text-white'"
                    >Curso</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('registar.cadeira')}}"
                    :class="page === 'registarCadeira' && '!text-white'"
                    >Cadeira</a
                  >
                </li>
              </ul>
          ...
          <li>
            <a
              class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              href="#"
              @click.prevent="selected = (selected === 'List' ? '':'List')"
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'List') || (page === 'formElements' || page === 'formLayout'  || page === 'listarDocente' || page === 'listarEstudante' || page === 'listarFaculdade' || page === 'listarCurso' || page === 'listarCadeira') }"
            >
              <svg
              class="fill-current"
              width="18"
              ...
              <svg
                class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                :class="{ 'rotate-180': (selected === 'List') }"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              class="translate transform overflow-hidden"
              :class="(selected === 'List') ? 'block' :'hidden'"
            >
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('listar.estudante')}}"
                    :class="page === 'listarEstudante' && '!text-white'"
                    >Estudantes</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('listar.docente')}}"
                    :class="page === 'listarDocente' && '!text-white'"
                    >Docentes</a
                  >
                </li>
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('listar.faculdade')}}"
                    :class="page === 'listarFaculdade' && '!text-white'"
                    >Faculdade</a
                  >
                </li>
                <li>
                ...
                <li>
                  <a
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{route('listar.cadeira')}}"
                    :class="page === 'listarCadeira' && '!text-white'"
                    >Cadeira</a
                  >
                </li>
              </ul>
