...
<html lang="en">
  <head>
    ...
    <title>Docentes | Dziva Ngutu</title>
                      ...
                      <table class="w-full table-auto">
                        ...
                        <tbody>
                            @foreach ($users as $u)
                                ...
                                <td class="border-b border-[#eee] px-4  dark:border-strokedark">
                                    @if ($u->role == "admin")
                                        <p class="inline-flex rounded-full bg-success bg-opacity-10 px-3 py-1 text-sm font-medium text-success">{{ $u->role }}</p>
                                    @else
                                        {{ $u->role }}
                                    @endif
                                </td>
