...
<html lang="en">
  <head>
    ...
    <title>
        Registar Docente | Dziva Ngutu
    </title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
  </head>

  <body
    x-data="{ page: 'registarDocente', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Registar Docente</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
                      ...
                      <form action="{{ route('utilizadores.criar') }}" method="POST">
                        ...
                        <div class="mb-4.5">
                            ...
                            >
                                ...
                                -- Selecione o privilegio
                                </option>
                                <option value="admin" class="text-body">Utilizador administrador</option>
                                <option value="normal" class="text-body">Utilizador normal</option>
                            </select>
                            <span
