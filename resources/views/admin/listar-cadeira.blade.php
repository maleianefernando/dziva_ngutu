...
<html lang="en">
  ...
  <body
    x-data="{ page: 'listarCadeira', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Cadeiras | Dziva Ngutu</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>

<body x-data="{ page: 'listarCadeira', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }" x-init="darkMode = JSON.parse(localStorage.getItem('darkMode'));
                                ...
                                <table class="w-full table-auto">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                                {{ \App\Models\Course::where('id', $s->course_id)->first()->name }}
                                            </td>
                                            <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
